...
var app = new Vue({
    ...
    data : {
        ...
        // settings : { apiUrl : 'http://localhost:8765' }, //https://api.10mates.com.au
        step : 1,
        modems: [],
        products: [],
        defProds: [],
    ...
    watch: {
        ...
        emailAddress(e) {
            ...
            this.checkEMail = !re.test(this.emailAddress)
        },
    },
    computed: {
      filteredModems() {
          if(this.selectedModem != '') {
              return this.modems.filter(e => e.modem_types.includes(this.selectedModem))
          } else {
              return this.modems
          }
      }
    ...
    methods : {
        handleFileChangeNoConn(e) {
            this.noConn4 = e.target.files
        },
        handleFileChangeDropout(e) {
            this.dropout4 = e.target.files
        },
        handleFileChangeSlowspeed(e) {
            this.slowSpeed4 = e.target.files
        },
        getModemData() {
            $.ajax({
                type : 'GET',
                url :'https://api.10mates.com.au/api/modems',
                crossDomain: true,
                dataType: 'jsonp',
                contentType: false,
                cache: false,
        ...
        getProducts() {
            $.ajax({
                type : 'GET',
                url : 'https://api.10mates.com.au/api/def_products',
                crossDomain: true,
                dataType: 'jsonp',
                contentType: false,
                cache: false,
        ...
        submitFault() {
            ...
            if(!this.faultField) {
                return $.alert({
                    ...
                    title : 'Oh No',
                    type: 'red',
                    content : 'Service ID is Required'
                });
            }
            formData.append('ticketContact[name]', 'Alex Moorhouse');
            formData.append('ticketContact[phone]', '+611800870817');
            formData.append('ticketContact[email]', 'alex@10mates.com.au');
            formData.append('siteContact[email]', this.emailAddress);
            formData.append('siteContact[phone]', this.mobileNo);
            formData.append('siteContact[name]', this.fullName);
            formData.append('customerReference', this.fullName);
            if(this.selectedType == "no_connectivity") {
                formData.append('serviceOrderID', this.faultField);
                formData.append('ticketNotes', `
                    No Connection Issue \n
                 ${this.noConn3}
                 `);
                if(this.noConn4) {
                    formData.append('attachment[fileName]', this.noConn4[0].name);
                    formData.append('attachment[rawAttachment]', this.noConn4[0]);
                }
                formData.append('ticketSymptom[workedPreviously]', this.noConn1);
                formData.append('ticketSymptom[isolationCheckDone]', false);
                formData.append('ticketSymptom[cpePowercycled]', false);
                formData.append('ticketSymptom[cablingChecked]', this.noConn2);
                formData.append('ticketSymptom[noConnectivity]', "NoConnectivity");
                formData.append('ticketSymptom[dropouts]', "");
                formData.append('ticketSymptom[performance]', "");
                formData.append('faultSymptom[faultType]', 'NoConnectivity');
                formData.append('faultSymptom[workedPreviously]', this.noConn1);
                formData.append('faultSymptom[faultDescription]', this.noConn3);
            }
            if(this.selectedType == "dropouts") {
                formData.append('serviceOrderID', this.faultField);
                formData.append('ticketNotes', `
                    Dropout Issue \n
                    Dropout Frequency: ${this.dropout2} \n
                    Dropout Nature: ${this.dropout3}
                `);
                if(this.dropout4) {
                    formData.append('attachment[fileName]', this.dropout4[0].name);
                    formData.append('attachment[rawAttachment]', this.dropout4[0]);
                }
                formData.append('ticketSymptom[workedPreviously]', false);
                formData.append('ticketSymptom[isolationCheckDone]', false);
                formData.append('ticketSymptom[cpePowercycled]', false);
                formData.append('ticketSymptom[cablingChecked]', this.dropout1);
                formData.append('ticketSymptom[dropoutsPerDay]', this.dropout2);
                formData.append('ticketSymptom[averageDuration]', this.dropout5);
                formData.append('ticketSymptom[noConnectivity]', "");
                formData.append('ticketSymptom[dropouts]', "Dropouts");
                formData.append('ticketSymptom[performance]', "");
                formData.append('faultSymptom[faultType]', 'Dropouts');
                formData.append('faultSymptom[workedPreviously]', false);
                formData.append('faultSymptom[faultDescription]', this.dropout2);
            }
            if(this.selectedType == "slow_speed") {
                formData.append('serviceOrderID', this.faultField);
                formData.append('ticketNotes', this.slowSpeed2);
                formData.append('ticketNotes', `
                    Slow Speed Issue \n
                    Date: ${this.slowSpeed1} \n
                    Slow Speed Nature: ${this.slowSpeed2} \n
                    Speedtest Links: ${this.slowSpeed3} \n
                `);
                if(this.slowSpeed4) {
                    formData.append('attachment[fileName]', this.slowSpeed4[0].name);
                    formData.append('attachment[rawAttachment]', this.slowSpeed4[0]);
                }
                formData.append('ticketSymptom[workedPreviously]', false);
                formData.append('ticketSymptom[isolationCheckDone]', false);
                formData.append('ticketSymptom[cpePowercycled]', false);
                ...
                formData.append('ticketSymptom[noConnectivity]', '');
                formData.append('ticketSymptom[dropouts]', '');
                formData.append('ticketSymptom[performance]', 'SlowSpeed');
                formData.append('faultSymptom[faultType]', 'SlowSpeed');
                formData.append('faultSymptom[workedPreviously]', false);
                formData.append('faultSymptom[faultDescription]', this.slowSpeed3);
            }
            this.submitting = true
            $.ajax({
                type : 'POST',
                url :'https://api.10mates.com.au/api/faults',
                data : formData,
                // dataType : 'json',
                contentType: false,
                cache: false,
                ...
                success: (data, textStatus, xhr) => {
                    ...
                    if(data.message['soapenv:Fault']) {
                        ...
                        return $.alert({
                            ...
                            animation: 'zoom',
                            type: 'red',
                            content : data.message['soapenv:Fault'].detail['ns1:Error'][0]['ns1:additionalInformation'] ?
                                data.message['soapenv:Fault'].detail['ns1:Error'][0]['ns1:additionalInformation'] :
                                data.message['soapenv:Fault'].detail['ns1:Error']['ns1:additionalInformation']
                        });
                    }
                    if(data.message['CreateServiceTicketResponse'].serviceTicketID) {
                        this.submitting = false
                        this.faultField =  ""
                        this.mobileNo = ""
                        this.selectedType = ""
                        ...
                        $.alert({
                            ...
                            type: 'green', 
                            title : 'Success',
                            content : `Successfully submitted a fault! Service Ticket ID: ${data.message['CreateServiceTicketResponse'].serviceTicketID}`,
                        });
                    }
                    else {
                        this.submitting = false
        ...
        animateToSection: function(elm, transition = 1000){
            $('html, body').animate({
                scrollTop: $(elm).offset().top
            }, transition);
        },
        // Order walkthrough functions
        choosePlan(){
            this.animateToSection('#internet-speed');
        },
        choosePlannbn(){
        ...
        scrollPay: function(){
            ...
            setTimeout(function(){
                self.animateToSection('#order');
            }, 100);
        },

        noBonus: function(){ 
            let self = this;
            $('.noBonusBtn').addClass('--is-active');
            this.showConfirmation = true;
            setTimeout(function(){
                self.animateToSection('#view-advanced-ordering');
            }, 300);
        },
       ...
       updateField : function(name, value){
           ...
           if(name == 'loadBalancedConn'){
                ...
                setTimeout(function(){
                    self.animateToSection('#additional-ip');
                }, 100);
           }
           if(name == 'internetSpeed'){
               ...
               setTimeout(function(){
                   // wifi-coverage
                   self.animateToSection('#wifi-coverage');
                   // if(location.href === "https://10mates.com.au/nbn/") {
                   //     self.animateToSection('#wifi-coverage');
                   // }
                   //  else {
                   //     self.animateToSection('#choose-modem');
                   // }
               }, 100);
           }
           ...
           if(name == 'modem'){
               ...
               setTimeout(function(){
                self.animateToSection('.modem-configuration');
               }, 100);
           }
           ...
           if(name == 'phoneHardware') {
               ...
               setTimeout(function(){
                   self.animateToSection('#calendar');
               }, 100);
           }
            ...
            if(name == 'bonus'){
                ...
                this.showConfirmation = true;
                setTimeout(function(){
                    self.animateToSection('.bonus-list');
                }, 100);
            }

            if(name == 'conf1' || name == 'conf2' || name == 'conf3'){
                this.order.confirm[name] =value;
                
                if(this.order.confirm['conf1'] && this.order.confirm['conf2'] && this.order.confirm['conf3']){
                    this.showOrderSummary = true;
                    setTimeout(function(){
                        self.animateToSection('#order-summary');
                    }, 100);
                }
            }
            ...
            if(name == 'professionalInstall'){
                this.showConfirmation = true;
                setTimeout(function(){
                    self.animateToSection('#confirmation');
                }, 100);
            }
            ...
            if(name == 'phoneCalls'){
                if(value != 'no-plan')
                    setTimeout(function(){
                        self.animateToSection('#phone-call-form');
                    }, 100);
                else{
                    self.showInstallationDay = true;
                    setTimeout(function(){
                        self.animateToSection('#calendar'); // no-plan
                    }, 100);
                }
            ...
            switch(id){
                ...
                case 'phone':
                    ...
                    switch(value){
                        ...
                        break;
                        case 'Grandstream WP810':
                        this.amounts.phone = 200;
                        break;
                        case 'Grandstream WP820':
                        this.amounts.phone = 300;
                        break;
                    }
                ...
                case 'plan': 
                    ...
                    if(value == 'nbn100' || value == 'nbn 100'){
                        this.amounts.internetSpeed = 130;
                        return 'nbn100 $130';
                    }else if(value == 'nbn 100/40' || value == 'nbn100/40'){
                        this.amounts.internetSpeed = 130;
                        return 'nbn100/40 $130';
                    }else if(value == 'nbn50' || value == 'nbn 50'){
                        this.amounts.internetSpeed = 120;
                        return 'nbn50 $120';
                    }else if(value == 'nbn50/20' || value == 'nbn 50/20'){
                        this.amounts.internetSpeed = 120;
                        return 'nbn50/20 $120';
                    }else if(value == 'nbn25' || value == 'nbn 25'){
                        this.amounts.internetSpeed = 90;
                        return 'nbn25 $90';
                    }else if(value == 'nbn 25/5' || value == 'nbn25/5'){
                        this.amounts.internetSpeed = 90;
                        return 'nbn25/5 $90';
                    }else if(value == 'nbn75' || value == 'nbn 75'){
                        this.amounts.internetSpeed = 150;
                        return 'nbn75 $150';
                    }else if(value == 'nbn75/10' || value == 'nbn 75/10'){
                        this.amounts.internetSpeed = 150;
                        return 'nbn75/10 $150';
                    }else if(value == 'nbn1000' || value == 'nbn 1000'){
                        this.amounts.internetSpeed = 250;
                        return 'nbn1000 $250';
                    }else if(value == 'nbn1000/50' || value == 'nbn 1000/50'){
                        this.amounts.internetSpeed = 250;
                        return 'nbn1000/50 $250';
                    }
                    return value;
                break;
                case 'modem':
                    value = this.order.modem;
                    // console.log(this.modems.filter(e => e.name == value), value)
                    if (value == "BYO") {
                        this.amounts.modem = 0;
                    }
                        // console.log(value)
                    else {
                        if(this.modems.length > 0 ) {
                            // console.log(this.modems.filter(e => e.name == value)[0].price, value)
                            this.amounts.modem = this.modems.filter(e => e.name == value)[0].price
                        }
                    }
                    // switch(value){
                    //     case 'BYO': 
       ...
       doQualify : function(selected){
            ...
            self.showWalkthroughButton = false;
                    ...
                    .done(function(res){
                        ...
                        try{
                            if(typeof res.error == 'undefined'){
                                ...
                                if(siteDetails.nbnServiceabilityClass == "6" || siteDetails.nbnServiceabilityClass == "5" || siteDetails.nbnServiceabilityClass == "4") {
                                    app.isClass6 = true
                                }
                                app.locLevel = '';
                                ...
                                console.log('Service Class', siteDetails.nbnServiceabilityClass);
                                
                                if($.inArray(siteDetails.nbnServiceabilityClass, [1,2,3,5,6,11,12,13,20,21,22,23,24,31,32,33])){
                                   
                                }else{
                                    if($.inArray(siteDetails.nbnServiceabilityClass, [0,4,10,30])){
                                        console.log('not ready for ordering');
                                ...
                                $.post(self.settings.apiUrl + '/api/sq/get/result', { 
                                    ...
                                    if($.inArray(Number(siteDetails.nbnServiceabilityClass), 
                                        ...
                                        $.post(self.settings.apiUrl + '/scrape/nbn/data', 
                                            ...
                                            if($('#tick-block').length > 0){
                                                setTimeout(function(){
                                                    $('html, body').animate({
                                                        scrollTop: $("#tick-block").offset().top
                                                    }, 1500);
                                                }, 800);
                                            }
                                        ...
                                        console.log('show green tick');
                                        app.showWalkthroughButton = true;
                                ...
                                $.ajax({
                                    type : 'GET',
                                    url : self.settings.apiUrl + '/api/products/' + siteDetails.nbnServiceabilityClass,
                                    crossDomain: true,
                                    dataType: 'jsonp',
                                    contentType: false,
                                    cache: false,
                                    ...
                                    success: (data, textStatus, xhr) => {
                                        if(xhr.status == 200) {
                                            ...
                                            app.defProds.map((def, idx) => {
                                                temp.push(def);
                                                console.log(idx);
                                            })
                                            temp.sort()

                                            temp.sort((a,b) => (a.price > b.price) ? 1 : ((b.price > a.price) ? -1 : 0));
                                            app.products = temp;
                                            app.isProducts = true;
                                            app.isDefProds = false;
                                        }
                                        else {
                                            console.log('-----')
                                        }
                            ...
                            $.alert({ 
                                ...
                                type: 'red', 
                                title: 'Error', 
                                content: 'The checker is currently down, please contact us in the chat and we will check it manually. Thanks' 
                            });
                        }
...
var app_home = new Vue({
    ...
    methods : {
        showRequestCallbackModal : function(){
...
$(document).ready(function(){
    app.computeTotals();
    // deselect calendar
    $('#calendar-wrapper .dhtmlxcalendar_cell_month_date').removeClass('dhtmlxcalendar_cell_month_date').addClass('dhtmlxcalendar_cell_month');
    ...
    $("#agree_keep_num").iCheck({
        ...
        console.log(app.phone.agree_yes);
        console.log(app.phone);
        console.log(app.phone.keep);
    ...
    $('.inaactd1').on('click', function(){
        ...
        app.showChooseBonus = true;
        setTimeout(function(){
            app.animateToSection('#bonus');
        }, 100);
    });
    ...
    $('.inaactd2, .inaactd2-1').on('click', function(){
        ...
        if($('.inaactd2').hasClass('--is-active') && $('.inaactd2-1').hasClass('--is-active')){
            app.showChooseBonus = true;
            setTimeout(function(){
                app.animateToSection('#bonus');
            }, 100);
    ...
    $('.inaactd3, .inaactd3-1').on('click', function(){
        ...
        if($('.inaactd3').hasClass('--is-active') && $('.inaactd3-1').hasClass('--is-active')){
            app.showChooseBonus = true;
            setTimeout(function(){
                app.animateToSection('#bonus');
            }, 100);
